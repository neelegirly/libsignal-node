...
Crypto foundation for the Neelegirly WhatsApp stack.
...
- Crypto foundation for Baileys
- Patch stability release
- Used by @neelegirly/baileys
...
```bash
npm install @neelegirly/libsignal
```
