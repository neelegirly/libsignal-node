...
[![baileys](https://img.shields.io/badge/baileys-2.2.20-ff8fab?style=for-the-badge)](https://www.npmjs.com/package/@neelegirly/baileys)
[![wa-api](https://img.shields.io/badge/wa--api-1.8.5-f4a261?style=for-the-badge)](https://www.npmjs.com/package/@neelegirly/wa-api)

<p align="center">
	<img src="https://files.catbox.moe/z90ndt.jpeg" width="420" alt="Neelegirly libsignal hero" />
</p>

**🗝️ Release-Stack:** `@neelegirly/libsignal 1.0.29` · `@neelegirly/baileys 2.2.20` · `@neelegirly/wa-api 1.8.5`
...
```bash
npm install @neelegirly/libsignal@1.0.29 --save-exact
```
...
- Stack-Versionen auf `1.0.29 / 2.2.20 / 1.8.5` angehoben
